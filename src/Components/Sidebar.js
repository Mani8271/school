        ...
        <nav className="space-y-4">
          ...
          {isSuperAdmin && (
            <>
              ...
              <SidebarDropdown label="Blogs" icon={<Person />} isOpen={openSections.blogs} toggle={() => toggleSection("blogs")} links={[
                { to: "/blogs/bloglist", label: "Bloglist" },
                { to: "/blogs/blogview", label: "Blogview" },
              ]} />
            </>
          )}
